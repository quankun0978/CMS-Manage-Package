...
const SubcriptionStatus = () => {
  ...
  return (
    <>
      ...
      />
      <Table columns={columns} dataSource={data} pagination={tableParams.pagination} onChange={handleTableChange} scroll={{ y: 330 }} style={{ transform: 'translateY(15px)' }} loading={loading} />
    </>
  );
};
