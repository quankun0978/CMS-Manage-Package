...
!(function () {
  ...
  i(
    ...
    M(C, m, { fa: 'solid', fass: 'solid', 'fa-solid': 'solid', fasr: 'regular', 'fa-regular': 'regular', fasl: 'light', 'fa-light': 'light' }),
    C)
  );
  var o = i((M((L = {}), h, { solid: 'fas', regular: 'far', light: 'fal', thin: 'fat', duotone: 'fad', brands: 'fab', kit: 'fak' }), M(L, m, { solid: 'fass', regular: 'fasr', light: 'fasl' }), L)),
    H =
      (i((M((l = {}), h, { fab: 'fa-brands', fad: 'fa-duotone', fak: 'fa-kit', fal: 'fa-light', far: 'fa-regular', fas: 'fa-solid', fat: 'fa-thin' }), M(l, m, { fass: 'fa-solid', fasr: 'fa-regular', fasl: 'fa-light' }), l)),
      i((M((c = {}), h, { 'fa-brands': 'fab', 'fa-duotone': 'fad', 'fa-kit': 'fak', 'fa-light': 'fal', 'fa-regular': 'far', 'fa-solid': 'fas', 'fa-thin': 'fat' }), M(c, m, { 'fa-solid': 'fass', 'fa-regular': 'fasr', 'fa-light': 'fasl' }), c)),
      i((M((s = {}), h, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }), M(s, m, { 900: 'fass', 400: 'fasr', 300: 'fasl' }), s)),
  ...
  function u(c, s, l) {
    var z = (2 < arguments.length && void 0 !== l ? l : {}).skipHooks,
      l = void 0 !== z && z,
      z = v(s);
    'function' != typeof d.hooks.addPack || l ? (d.styles[c] = e(e({}, d.styles[c] || {}), z)) : d.hooks.addPack(c, v(s)), 'fas' === c && u('fa', s);
  }
  var g = {
    'trash-can': [
      448,
