...
!(function () {
  ...
  function st() {
    ...
    return (
      ('fa' === n && i === e) ||
        ((t = new RegExp('\\.'.concat('fa', '\\-'), 'g')), (a = new RegExp('\\--'.concat('fa', '\\-'), 'g')), (e = new RegExp('\\.'.concat(e), 'g')), (r = r.replace(t, '.'.concat(n, '-')).replace(a, '--'.concat(n, '-')).replace(e, '.'.concat(i)))),
      r
    );
  }
  var ct = !1;
  ...
  function Ht(t, a) {
    ...
    a = t.reduce(function (t, a) {
      ...
      return (
        xt[a] ? ((a = Ot[o].includes(a) ? H[o][a] : a), (r = a), (t.prefix = a)) : -1 < zt[o].indexOf(a) ? ((r = a), (t.prefix = Dt(a, { family: o }))) : e ? (t.iconName = e) : a !== J.replacementClass && a !== i[I] && a !== i[L] && t.rest.push(a),
        !n &&
          t.prefix &&
          t.iconName &&
  ...
  function xa(t, a) {
    var e = 1 < arguments.length && void 0 !== a ? a : { styleParser: !0 },
      ...
      c = e.styleParser
        ...
        : [];
    return k(
      { iconName: i, title: t.getAttribute('title'), titleId: t.getAttribute('data-fa-title-id'), prefix: r, transform: $, mask: { iconName: null, prefix: null, rest: [] }, maskId: null, symbol: !1, extra: { classes: o, styles: c, attributes: s } },
      a
    );
  }
  var Aa = ut.styles;
